...
def __get_mermaid_prompt() -> str:
    """
    Prompt para transcrição de diagramas em Mermaid e filtragem de figuras irrelevantes.
    """
    return (
        "Analise a imagem fornecida. "
        "Se for um diagrama (fluxograma, sequência, classe, etc.), transcreva-o como um bloco de código Mermaid válido para Markdown. "
        "Ignore figuras decorativas, logotipos ou imagens que não agregam informação relevante ao conteúdo do documento. "
        "Responda apenas com o bloco de código Mermaid, sem explicações ou texto adicional."
    )
